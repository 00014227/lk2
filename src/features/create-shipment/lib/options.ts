...
export const INCOTERMS = ["EXW", "FCA", "CPT", "CIP", "DAP", "DDP", "FOB", "CFR", "CIF", "FAS", "FCA/CPT", "FOB/DAP"];
export const COMMODITY_TYPES = ["Electronics", "Textiles", "Food & Beverages", "Chemicals", "Metals", "Machinery", "Auto Parts", "Construction Materials", "Other"];
export const PACKAGE_TYPES = ["Pallets", "Boxes / Cartons", "Drums", "Bags", "Big Bags", "Bulk", "Rolls"];
export const CONTAINER_TYPES = ["20'GP", "40'GP", "40'HC", "20'RF (Reefer)", "40'RF (Reefer)", "45'HC", "20'OT (Open Top)", "40'OT"];
