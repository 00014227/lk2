        ...
        <header className="grid gap-4 rounded-[34px] border border-white/70 bg-[#0d2a3b] p-6 text-white shadow-[0_24px_80px_rgba(16,35,48,0.18)] lg:grid-cols-[1.35fr_0.65fr] lg:p-8">
          <div className="space-y-5">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold tracking-[0.3em] text-white/65 uppercase">
                  TransAsia Logistics
                </p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Badge className="bg-teal-400/18 text-teal-200" variant="neutral">
                Backend API
              </Badge>
              {loading ? (
            ...
            <div className="inline-flex rounded-full border border-white/70 bg-white/85 p-1 shadow-[0_14px_30px_rgba(16,35,48,0.06)]">
              <button
                className={`rounded-full px-5 py-2.5 text-sm font-semibold transition ${
                  activeTab === "map"
                    ? "bg-primary text-primary-foreground shadow-[0_10px_24px_rgba(15,118,110,0.22)]"
                    : "text-slate-600"
                }`}
